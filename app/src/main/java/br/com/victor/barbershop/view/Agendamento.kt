...
import br.com.victor.barbershop.databinding.ActivityAgendamentoBinding
        ...
        binding.btAgendar.setOnClickListener {
            ...
            when {
                ...
                hora < "8:00" && hora > "19:00" -> {
                    mensagem(
                        it,
                        "Barber Shop está fechado - horário de atendimento das 8:00 as 19:00",
                        "#FF0000"
                    )
                ...
                barbeiro3.isChecked && data.isNotEmpty() && hora.isNotEmpty() -> {
                    salvarAgendamento(it, nome, "Lucas Andrade", data, hora)
